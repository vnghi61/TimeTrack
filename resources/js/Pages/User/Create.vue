...
const saveUser = async () => {
  ...
  try {
    ...
    if (error.errors) {
      ...
      errors.general = 'Có lỗi xảy ra khi tạo user'
    }
  } finally {
    loading.value = false
  }
  ...
  <SidebarProvider>
    ...
    <SidebarInset>
        ...
        <div class="flex items-center gap-2 px-4 flex-1">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator class="hidden md:block" />
              <BreadcrumbItem>
                <BreadcrumbPage>Thêm User</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
      ...
      <div class="flex flex-1 flex-col gap-4 p-4 pt-0">
        <div class="space-y-6">
          <h1 class="text-3xl font-bold text-gray-900">Thêm User Mới</h1>
          ...
          <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-4">
              ...
              <div class="flex gap-3 pt-4">
                <Button @click="saveUser" :disabled="loading" class="bg-blue-600 hover:bg-blue-700">
                  <span v-if="loading" class="flex items-center">
                    <div class="animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2"></div>
                    Đang xử lý...
                  </span>
                  <span v-else>Tạo User</span>
                </Button>
