...
const updateRole = async () => {
  ...
  if (!form.name) errors.name = 'Tên vai trò là bắt buộc'
  ...
  try {
    ...
    if (error.errors) {
      ...
      errors.general = 'Có lỗi xảy ra khi cập nhật vai trò'
    }
  } finally {
    loading.value = false
  }
  ...
  <SidebarProvider>
    ...
    <SidebarInset>
        ...
        <div class="flex items-center gap-2 px-4 flex-1">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink href="/role">Quản lý Vai trò</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator class="hidden md:block" />
              <BreadcrumbItem>
                <BreadcrumbPage>Chỉnh sửa Vai trò</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
      ...
      <div class="flex flex-1 flex-col gap-4 p-4 pt-0">
        <div class="space-y-6">
          <h1 class="text-3xl font-bold text-gray-900">Chỉnh sửa Vai trò</h1>
          ...
          <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-4">
              ...
              <div class="flex gap-3 pt-4">
                <Button @click="updateRole" :disabled="loading" class="bg-blue-600 hover:bg-blue-700">
